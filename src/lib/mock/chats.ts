...
export const channels: ChatChannel[] = [
  {
    ...
    description: "Alle deelnemers en coaches van Jouw Programma Q2 2026.",
...
export const messages: ChatMessage[] = [
  // Algemeen channel
  {
    ...
    authorId: "u_imro",
    content:
      "Welkom allemaal in Jouw Programma Q2 2026. Stel jezelf even voor in 2 zinnen. Wie ben je, wat doe je, wat zoek je in dit programma?",
